package in.co.sanchay.speech.common;

import in.co.sanchay.corpus.parallel.APCProperties;
import in.co.sanchay.corpus.parallel.aligner.AlignmentFeature;
import in.co.sanchay.corpus.simple.SimpleSentence;
import in.co.sanchay.matrix.SparseMatrixDouble;
import in.co.sanchay.text.spell.PhoneticCharacter;
import in.co.sanchay.text.spell.*;
