...
import in.co.sanchay.GlobalUtils;
import in.co.sanchay.SanchayMain;
import in.co.sanchay.SanchayMainEvent;
import in.co.sanchay.common.SanchayClientsStateData;
...
import in.co.sanchay.corpus.ssf.impl.SSFStoryConvertEncoding;
import in.co.sanchay.corpus.ssf.impl.SSFStoryImpl;
import in.co.sanchay.corpus.ssf.impl.SSFTextImpl;
...
import in.co.sanchay.corpus.validation.SyntacticAnnotationValidationJPanel;
import in.co.sanchay.gui.SelectTaskJPanel;
import in.co.sanchay.gui.WorkJPanelInterface;
import in.co.sanchay.gui.clients.AnnotationClient;
import in.co.sanchay.gui.clients.SanchayRemoteWorkJPanel;
import in.co.sanchay.mlearning.common.MLCorpusConverter;
import in.co.sanchay.mlearning.crf.CRFAnnotationMain;
import in.co.sanchay.properties.KeyValueProperties;
import in.co.sanchay.properties.PropertiesManager;
import in.co.sanchay.properties.PropertiesTable;
import in.co.sanchay.properties.PropertyTokens;
import in.co.sanchay.table.SanchayTableModel;
import in.co.sanchay.text.editor.gui.TextEditorJPanel;
import in.co.sanchay.text.enc.conv.EncodingConverterUtils;
import in.co.sanchay.tree.SanchayEdge;
import in.co.sanchay.tree.SanchayEdges;
...
import in.co.sanchay.tree.gui.SanchayTreeViewerJPanel;
import in.co.sanchay.util.UtilityFunctions;
import in.co.sanchay.util.file.FileMonitor;
import in.co.sanchay.util.file.SanchayBackup;
import in.co.sanchay.util.gui.SanchayGUIUtils;
import in.co.sanchay.util.query.SSFFindReplace;
...
import in.co.sanchay.common.types.*;
...
import in.co.sanchay.gui.clients.*;
import in.co.sanchay.gui.common.DialogFactory;
import in.co.sanchay.gui.common.FileSelectionJPanel;
...
import in.co.sanchay.gui.common.FileDisplayer;
import in.co.sanchay.gui.common.SanchayJDialog;
import in.co.sanchay.server.dto.tree.impl.RemoteFileNode;
import in.co.sanchay.table.gui.DisplayEvent;
import in.co.sanchay.table.gui.FindEvent;
import in.co.sanchay.table.gui.FindEventListener;
import in.co.sanchay.table.gui.SanchayActionTableCellEditor;
import in.co.sanchay.table.gui.SanchayDefaultJTable;
import in.co.sanchay.text.editor.gui.*;
...
//above I added later april
    ...
    public void openFileMode()
    {
        taskSetupJPanel = new SyntacticAnnotationTaskSetupJPanel(true, this);
        taskSetupJPanel.setOwner(owner);
        SanchayJDialog openDialog = new SanchayJDialog(owner, GlobalProperties.getIntlString("Sanchay_Syntactic_Annotation_Task_Setup"), true, (JPanelDialog) taskSetupJPanel);
        openDialog.pack();
...
//        ssfStory.clearHighlights();
    ...
    private void showSearchResults(SanchayTableModel matches, String langEnc, int tcount) {
        ...
        if(owner != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, SanchayTableJPanel.DEFAULT_MODE);
        else if(dialog != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, SanchayTableJPanel.DEFAULT_MODE);
    ...
    private File[] getSelectedFiles() {
        ...
        SanchayJDialog fsDialog = (SanchayJDialog) DialogFactory.showFileSelectionDialog(owner, GlobalProperties.getIntlString("FileSelectionJPanel"), true, new File(curDir));
    ...
    public SanchayTableModel getFindOptionsTable()
    {
        ...
        SanchayJDialog findDialog = new SanchayJDialog(owner, GlobalProperties.getIntlString("Find"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
    ...
    public SanchayTableModel getReplaceOptionsTable()
    {
        ...
        SanchayJDialog findDialog = new SanchayJDialog(owner, GlobalProperties.getIntlString("Replace"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
...
//                    cells[i][2] = ((SSFNode) n.getParent()).convertToBracketForm(1);
        ...
        SanchayTableModel matches = new SanchayTableModel(cells, new String[] {GlobalProperties.getIntlString("Sentence"), GlobalProperties.getIntlString("Matched_Text"), GlobalProperties.getIntlString("Context")});
...
//                }
    ...
    private SanchayTableModel getStats(SSFStory story) {
        ...
        SanchayTableModel matches = new SanchayTableModel(cells, new String[] {GlobalProperties.getIntlString("Sentences"), GlobalProperties.getIntlString("Chunks"), GlobalProperties.getIntlString("Words"), GlobalProperties.getIntlString("Characters")});
...
//            save(null);
    ...
    public void configure(SSFStory story)
    {
        ...
        try {
            ...
            if(dialog != null)
            {
                dialog.setTitle(GlobalProperties.getIntlString("Sanchay:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
            else if(owner != null)
            {
                owner.setTitle(GlobalProperties.getIntlString("Sanchay:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
