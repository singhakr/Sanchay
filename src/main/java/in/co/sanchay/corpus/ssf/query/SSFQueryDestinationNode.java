...
package in.co.sanchay.corpus.ssf.query;
...
import in.co.sanchay.common.types.SSFQueryTokenType;
        ...
        else if(args.length == 1)
        {
            ...
            if(destination.getLocation().equals(""))
            {
                ...
                if(returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    destination.setCharset(JOptionPane.showInputDialog(SanchayMain.getSanchayMain(), GlobalProperties.getIntlString("Please_enter_the_charset:"), GlobalProperties.getIntlString("UTF-8")));
                }
                else {
                    return false;
                }
