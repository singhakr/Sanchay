...
import in.co.sanchay.gui.common.LocalKeyboardShorcutEditorJPanel;
...
import in.co.sanchay.propbank.FramesetRoleset;
import in.co.sanchay.propbank.gui.FramesetExamplesJPanel;
...
import in.co.sanchay.text.enc.conv.UTF82WX;
...
public class PropbankInfoJPanel extends javax.swing.JPanel {
    ...
    private void editWordInfo()
    {
        ...
        if(owner != null)
            editJDialog = new SanchayJDialog(owner, GlobalProperties.getIntlString("Edit_Frameset"), true, (JPanelDialog) framesetJPanel);
        else if(dialog != null)
            editJDialog = new SanchayJDialog(dialog, GlobalProperties.getIntlString("Edit_Frameset"), true, (JPanelDialog) framesetJPanel);
