...
import in.co.sanchay.annotation.common.AutomaticAnnotationJPanel;
import in.co.sanchay.corpus.discourse.DiscourseAnnotationJPanel;
import in.co.sanchay.corpus.manager.gui.NGramLMJPanel;
import in.co.sanchay.corpus.parallel.gui.ParallelMarkupWorkJPanel;
import in.co.sanchay.corpus.parallel.gui.SentenceAlignmentInterfaceJPanel;
import in.co.sanchay.corpus.parallel.gui.WordAlignmentInterfaceJPanel;
import in.co.sanchay.corpus.ssf.tree.SSFPhrase;
import in.co.sanchay.gui.clients.SanchayRemoteWorkJPanel;
import in.co.sanchay.gui.common.ApplicationDescription;
import in.co.sanchay.gui.common.IntegratedResourceAccessorJPanel;
import in.co.sanchay.gui.common.SanchayCharmapJPanel;
import in.co.sanchay.gui.shell.SanchayShellJPanel;
import in.co.sanchay.langenc.gui.LanguageEncodingIdentifierJPanel;
import in.co.sanchay.propbank.Frameset;
import in.co.sanchay.resources.shabdanjali.DictionaryEditorJPanel;
import in.co.sanchay.table.gui.SanchayTableJPanel;
import in.co.sanchay.text.editor.gui.RichTextEditorJPanel;
import in.co.sanchay.text.spell.gui.DictionaryFSTJPanel;
import in.co.sanchay.tree.SanchayMutableTreeNode;
import in.co.sanchay.tree.gui.SanchayTreeDrawingJPanel;
import in.co.sanchay.util.gui.DocumentConverterJPanel;
import in.co.sanchay.util.gui.FileSplitterJPanel;
import in.co.sanchay.word.gui.WordListJPanel;
import in.co.sanchay.corpus.ssf.gui.SyntacticAnnotationWorkJPanel;
import in.co.sanchay.propbank.gui.FramesetJPanel;
