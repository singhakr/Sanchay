...
import in.co.sanchay.gui.shell.commands.engines.AccessResources;
import in.co.sanchay.gui.shell.commands.engines.AlignSentences;
import in.co.sanchay.gui.shell.commands.engines.AlignWords;
import in.co.sanchay.gui.shell.commands.engines.Annotate;
import in.co.sanchay.gui.shell.commands.engines.BuildWordList;
import in.co.sanchay.gui.shell.commands.engines.ChangeDirectory;
import in.co.sanchay.gui.shell.commands.engines.CleanHTML;
import in.co.sanchay.gui.shell.commands.engines.CloseTab;
import in.co.sanchay.gui.shell.commands.engines.CommandHelp;
import in.co.sanchay.gui.shell.commands.engines.CompileContextModels;
import in.co.sanchay.gui.shell.commands.engines.CompileNGramModel;
import in.co.sanchay.gui.shell.commands.engines.ConcatenateFiles;
import in.co.sanchay.gui.shell.commands.engines.ConvertEncoding;
import in.co.sanchay.gui.shell.commands.engines.ConvertFormat;
import in.co.sanchay.gui.shell.commands.engines.EstimateDeepSimilarity;
import in.co.sanchay.gui.shell.commands.engines.EstimateFunctionalSimilarity;
import in.co.sanchay.gui.shell.commands.engines.EstimateSurfaceSimilarity;
import in.co.sanchay.gui.shell.commands.engines.EvaluateExpression;
import in.co.sanchay.gui.shell.commands.engines.ExecuteJavaCode;
import in.co.sanchay.gui.shell.commands.engines.ExecutePythonCode;
import in.co.sanchay.gui.shell.commands.engines.ExecuteSystemCommand;
import in.co.sanchay.gui.shell.commands.engines.FileDifference;
import in.co.sanchay.gui.shell.commands.engines.GetCorpusStatistics;
import in.co.sanchay.gui.shell.commands.engines.GetScriptStatistics;
import in.co.sanchay.gui.shell.commands.engines.IdentifyLanguageEncoding;
import in.co.sanchay.gui.shell.commands.engines.IndexDocuments;
import in.co.sanchay.gui.shell.commands.engines.ListFiles;
import in.co.sanchay.gui.shell.commands.engines.NewTab;
import in.co.sanchay.gui.shell.commands.engines.NormalizeText;
import in.co.sanchay.gui.shell.commands.engines.PresentWorkingDirectory;
import in.co.sanchay.gui.shell.commands.engines.RetrieveDocuments;
import in.co.sanchay.gui.shell.commands.engines.SegmentMorphemes;
import in.co.sanchay.gui.shell.commands.engines.Shutdown;
import in.co.sanchay.gui.shell.commands.engines.SplitFiles;
import in.co.sanchay.gui.shell.commands.engines.Tokenize;
import in.co.sanchay.gui.shell.commands.engines.Translate;
import in.co.sanchay.gui.shell.commands.engines.TranslateNumberExpressions;
import in.co.sanchay.gui.shell.commands.engines.Transliterate;
import in.co.sanchay.gui.shell.commands.engines.WGet;
