...
package in.co.sanchay.properties.gui;
 ...
 * @author  anil
 */
public class PropertiesManagerJPanel extends javax.swing.JPanel implements SanchayClient, JPanelDialog {
        ...
        if(selProperty.equals("") == false && selContainer.equals("") == false) {
            ...
            try {
                if(pt == PropertyType.PROPERTY_TOKENS) {
                    ...
                    containerJPanel = new SanchayTableJPanel(tableFile, charset, true, null, SanchayTableJPanel.MINIMAL_MODE, GlobalProperties.getIntlString("hin::utf8"));
                }
