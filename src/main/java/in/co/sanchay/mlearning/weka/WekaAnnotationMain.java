...
import in.co.sanchay.formats.converters.Arff2SSF;
import in.co.sanchay.formats.converters.SSF2Arff;
import in.co.sanchay.mlearning.maxent.WekaNERExperiment;
import iitb.utils.Options;
import in.co.sanchay.annotation.DefaultAnnotationMain;
import in.co.sanchay.annotation.SanchayAnnotationMain;
...
public class WekaAnnotationMain extends DefaultAnnotationMain implements SanchayAnnotationMain {
    ...
    public WekaAnnotationMain() {
        ...
        ssf2ML = new in.co.sanchay.formats.converters.SSF2Arff();
        ml2SSF = new Arff2SSF();
